...
define(["common"], function(common) {
    ...
    FileUploader.prototype = {
        ...
        parseTemplate: function() {
            ...
            var template = $("#fileUploaderTemplate").html().format();
        ...
        API: {
            ...
            "reset": function() {
                ...
                $form.remove();
                baseDom.val(""); // fix ie bugs (reset will not change $(":file").val() under ip address access, for some security reason ?)
            }
        }
    };
    ...
    function main(options) {
        ...
        return this.each(function(_, dom) {
            ...
            if (typeof options === 'string') {
                ...
                fileUploaderObj.API[methodName].apply(fileUploaderObj, args);
            }
